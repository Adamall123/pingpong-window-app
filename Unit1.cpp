...
void __fastcall TForm1::TimerBallTimer(TObject *Sender) {
    ...
    if(ballReflectionFromPallete(ImageBall, imagePallete1) && (reflectedOnPallete2 || hitFirstTime)) {
        ...
        hitFirstTime = false;
        //sndPlaySound("music/zapsplat_sport_ball_netball.wav", SND_ASYNC);
...
void __fastcall TForm1::FormCreate(TObject *Sender) {
    ...
    if(player1->getPoints() == pointsToWin || player2->getPoints() == pointsToWin) {
        ...
        LabelInfo->Visible = true;
        //sndPlaySound("music/zapsplat_multimedia_game_sound_fun_arcade_organ_positive_win_expression.wav", SND_ASYNC);
